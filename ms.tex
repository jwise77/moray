...
special cases.  The most basic case was first considered by
\citet{Stroemgren39} for a radiation source ionizing a static uniform
neutral medium.  He found that the delineation between the neutral and
ionized medium was found to be approximately the mean free path of the
ionizing radiation.  His seminar work was expanded upon by
...
fronts. (add evolution of an \ion{H}{2} region)
...
\item Moment methods---The angular moments of the radiation field can
  ...
  characteristics \citep{Stone92_RT}, with long characteristics
  \citep{Finlator08}, with a variable Eddington tensor in the
...
\item Ray tracing---Radiation can be propagated along rays that extend
  through the compuational grid \citep[e.g.][]{Mellema98, Razoumov99,
    Abel99, Ciardi00, Ritzerveld03, Whalen05, Rijkhorst05, Mellema06,
    Alvarez06, Trac07, Krumholz07_ART, Paardekooper10} or particle set
  \citep[e.g.][]{Susa06, Johnson07, Pawlik08, Altay08, Hasegawa09,
    Pawlik10}.  In general, these methods are very accurate but
...
density fields from N-body simulations \citep{Ciardi01, Sokasian01,
  McQuinn05, Iliev07}.  Any hydrodynamical response to the radiation
field was thus ignored.  Several radiative transfer codes were
compared in four purely radiative transfer tests in \citet[hereafter
RT06]{RT06}.  Only recently has the radiative transfer equation been
coupled to the hydrodynamics in three-dimensions.  In the second
comparision paper \citep[hereafter RT09]{Iliev09}, results from these
...
accreting supermassive black holes \citep{Kim11}.  We have included
Enzo+Moray in the latest public release of
