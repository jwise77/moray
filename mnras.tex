...
\begin{abstract}
  ...
  includes an expanding \hii region in a magnetized medium,
...
\hii regions in spherical symmetry and plane-parallel ionization
...
expanding \hii illuminated by a massive star in a uniform
medium:
%
\begin{enumerate}
...
growth of an \hii region from a 100\Ms~Population III (Pop III)
...
\hii regions and a smooth temperature transition to the neutral
ambient medium.
...
\hii region in an initially uniform density field and constant
...
\hii regions of Population III stars.  Furthermore, we have
