...
solution.  In Fig. \ref{fig:test1_HI}, we show a slice of the
...
Fig. \ref{fig:test3_2} depicts the average ionized fraction and
...
The growth of the ionization front radius is shown in Fig.
...
a shock.  Densities in this shock, as seen in Fig.
...
Fig. \ref{fig:test5_2} shows the progression of the ionization front
...
our calculated ionization front radius and velocity, shown in Fig.
...
is now over-pressurized, as seen in the pressure plot in Fig.
...
Fig. \ref{fig:test10} shows the ionization front overtaking and
...
photo-ionization rates, shown in Fig. \ref{fig:test12_kph}.  The
...
density, temperature, ionized fraction, and pressure in Fig.
